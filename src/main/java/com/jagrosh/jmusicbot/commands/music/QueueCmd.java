...
import com.jagrosh.jmusicbot.utils.TextUtil;
...
public class QueueCmd extends MusicCommand {
    ...
    public void doCommand(CommandEvent event) {
        ...
        if (list.isEmpty()) {
            Message nowp = bot.getConfig().createTextUtil().getNowPlaying(event.getJDA(), bot.setUpHandler(event.getGuild()), bot.getConfig(), event.getGuild());
            Message nonowp = bot.getConfig().createTextUtil().getNoMusicPlaying(
                    bot.getConfig(),
                    event.getGuild(),
                    bot.setUpHandler(event.getGuild()).getPlayer()
            );
